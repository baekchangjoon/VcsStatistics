...
public class GitLabTestcontainersTest {
    ...
    @Test
    void testFullIntegrationWithTestcontainers() {
        System.out.println("IntegrationTest 실행 - GitLab URL: " + gitlabUrl);
        System.out.println("IntegrationTest 실행 - Project ID: " + projectId);
        ...
        Map<String, UserStat> statMap = stats.generateStats(String.valueOf(projectId), "2023-01-01", "2023-12-31", users);
        ...
        System.out.println("IntegrationTest 완료");
    }
}